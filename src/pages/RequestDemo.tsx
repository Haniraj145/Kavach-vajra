...
const RequestDemo = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const subject = encodeURIComponent("Request Demo - KAVACH Vajra");
    ...
    window.location.href = `mailto:kavachvajra@gmail.com?subject=${subject}&body=${body}`;
    ...
    <div className="min-h-screen pt-20 px-4 pb-20">
      <div className="mx-auto max-w-2xl">
        ...
        >
          ...
          <p className="text-muted-foreground">
            Experience our working simulation. Request exclusive demo access.
          </p>
        </motion.div>

        <form
          onSubmit={handleSubmit}
          className="gradient-card rounded-2xl border border-border p-8 space-y-4"
        >
          {fields.map((field) => (
            <div key={field.key}>
          ...
          <div>
            <label className="text-sm font-medium mb-1 block">
              Why do you want to see the demo? *
            </label>
            <textarea
              required
              rows={3}
